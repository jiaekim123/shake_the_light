...
public class ColorPicker extends View {
	...
	private BluetoothChat mbluetooth;
	...
	private byte[] byteColor = new byte[3];
	...
	public void setNewCenterColor(int color) {
		...
		invalidate();
		Log.e("setNewCenterColor : Color",Integer.toString(color));
		
		int changedColor = color+16777215;
		//String binaryColor = Integer.toBinaryString(changedColor);
		//Log.e("BinarySring_ Color : ",binaryColor);
		
		byteColor = intToByteArray(changedColor);
		//String byteString = new String(byteColor);
		//Log.e("byteString_Color :",byteString);
		//mbluetooth.sendMessage(byteColor);
	...
	public void setOldCenterColor(int color) {
		...
		mCenterOldPaint.setColor(color);
		invalidate();
		Log.e("setOldCenterColor : Color",Integer.toString(color));
	}
